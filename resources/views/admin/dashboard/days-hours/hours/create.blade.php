            ...
            <div class="w-full flex justify-center">
                <div class="w-2/3 px-10">
                    <div class="">
                        ...
                        <form method="POST" action="{{ route('employee.horaire.store') }}">
                        @csrf
                        <!--  Name -->
                            <div>
                                <x-label for="denomination" :value="__('Denomination')" />

                                <x-input id="denomination" class="block mt-1 w-full" type="text" name="denomination" :value="old('name')" required autofocus />
                            </div>

                            <div class="mt-4">
                                <x-label for="horaire" :value="__('Plage horaire')" />

                                <x-input id="horaire" class="block mt-1 w-full" type="text" name="horaire" :value="old('horaire')" required autofocus />
                            </div>
